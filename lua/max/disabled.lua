...
g.loaded_netrwSettings = true -- disable netrw
g.loaded_remote_plugins = true -- disable remote plugins
g.loaded_rrhelper = true -- disable rrhelper
g.loaded_spellfile_plugin = true -- disable spellfile
g.loaded_tar = true -- disable tar
g.loaded_tarPlugin = true -- disable tar
g.loaded_tutor = true -- disable tutor
g.loaded_tutor_mode_plugin = true -- disable tutor
